      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-surface">
        <div className="w-full max-w-[360px]">
          ...
          <button type="button" onClick={handleGoogle} disabled={googleLoading}
            className="w-full h-10 flex items-center justify-center gap-2.5 border border-border bg-card rounded-[8px] text-sm font-semibold text-foreground hover:bg-surface-2 transition-colors disabled:opacity-60 mb-4">
